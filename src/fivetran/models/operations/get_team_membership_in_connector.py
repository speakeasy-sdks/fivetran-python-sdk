...
@dataclasses.dataclass
class GetTeamMembershipInConnector200ApplicationJSON:
...
class GetTeamMembershipInConnectorResponse:
    ...
    get_team_membership_in_connector_200_application_json_object: Optional[GetTeamMembershipInConnector200ApplicationJSON] = dataclasses.field(default=None)
