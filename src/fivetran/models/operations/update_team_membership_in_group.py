...
@dataclasses.dataclass
class UpdateTeamMembershipInGroup200ApplicationJSON:
...
class UpdateTeamMembershipInGroupResponse:
    ...
    update_team_membership_in_group_200_application_json_object: Optional[UpdateTeamMembershipInGroup200ApplicationJSON] = dataclasses.field(default=None)
