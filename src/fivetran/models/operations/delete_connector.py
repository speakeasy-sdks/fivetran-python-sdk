...
@dataclasses.dataclass
class DeleteConnector200ApplicationJSON:
...
class DeleteConnectorResponse:
    ...
    delete_connector_200_application_json_object: Optional[DeleteConnector200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful response"""  
