...
@dataclasses.dataclass
class GetUserMembershipsInConnectors200ApplicationJSONData:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetUserMembershipsInConnectors200ApplicationJSON:
    r"""Successful response"""
    
    code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})
    r"""Response status code"""
    data: Optional[GetUserMembershipsInConnectors200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class GetUserMembershipsInConnectorsResponse:
    ...
    get_user_memberships_in_connectors_200_application_json_object: Optional[GetUserMembershipsInConnectors200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful response"""
