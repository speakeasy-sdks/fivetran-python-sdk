...
@dataclasses.dataclass
class UpdateUserMembershipInGroup200ApplicationJSON:
...
class UpdateUserMembershipInGroupResponse:
    ...
    update_user_membership_in_group_200_application_json_object: Optional[UpdateUserMembershipInGroup200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful response"""  
