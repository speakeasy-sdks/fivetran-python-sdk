...
class UpdateUserMembershipPathParams:
    team_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'teamId', 'style': 'simple', 'explode': False }})
    user_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'userId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class UpdateUserMembershipHeaders:
    accept: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Accept', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class UpdateUserMembershipRequest:
    headers: UpdateUserMembershipHeaders = dataclasses.field()
    path_params: UpdateUserMembershipPathParams = dataclasses.field()
