...
@dataclasses.dataclass
class GetUserInTeam200ApplicationJSON:
...
class GetUserInTeamResponse:
    ...
    get_user_in_team_200_application_json_object: Optional[GetUserInTeam200ApplicationJSON] = dataclasses.field(default=None)
