...
@dataclasses.dataclass
class GetTeamMembershipsInGroups200ApplicationJSONData:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetTeamMembershipsInGroups200ApplicationJSON:
    r"""Successful response"""
    
    code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})

    r"""Response status code"""
    data: Optional[GetTeamMembershipsInGroups200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class GetTeamMembershipsInGroupsResponse:
    ...
    get_team_memberships_in_groups_200_application_json_object: Optional[GetTeamMembershipsInGroups200ApplicationJSON] = dataclasses.field(default=None)
