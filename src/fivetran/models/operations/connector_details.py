...
@dataclasses.dataclass
class ConnectorDetails200ApplicationJSON:
...
class ConnectorDetailsResponse:
    ...
    connector_details_200_application_json_object: Optional[ConnectorDetails200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful response"""  
