...
@dataclasses.dataclass
class ListAllRoles200ApplicationJSONData:
    
    items: Optional[list[shared_roleresponse.RoleResponse]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
...
class ListAllRoles200ApplicationJSON:
    ...
    data: Optional[ListAllRoles200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
