...
@dataclasses.dataclass
class DeleteTeamMembershipInConnector200ApplicationJSON:
...
class DeleteTeamMembershipInConnectorResponse:
    ...
    delete_team_membership_in_connector_200_application_json_object: Optional[DeleteTeamMembershipInConnector200ApplicationJSON] = dataclasses.field(default=None)
