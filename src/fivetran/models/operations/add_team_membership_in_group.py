...
@dataclasses.dataclass
class AddTeamMembershipInGroup201ApplicationJSON:
...
class AddTeamMembershipInGroupResponse:
    ...
    add_team_membership_in_group_201_application_json_object: Optional[AddTeamMembershipInGroup201ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful response"""
