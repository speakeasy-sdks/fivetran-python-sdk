...
@dataclasses.dataclass
class ConnectorSchemaConfig200ApplicationJSON:
...
class ConnectorSchemaConfigResponse:
    ...
    connector_schema_config_200_application_json_object: Optional[ConnectorSchemaConfig200ApplicationJSON] = dataclasses.field(default=None)
