...
@dataclasses.dataclass
class CreateDbtProject201ApplicationJSON:
...
class CreateDbtProjectResponse:
    ...
    create_dbt_project_201_application_json_object: Optional[CreateDbtProject201ApplicationJSON] = dataclasses.field(default=None)
