...
@dataclasses.dataclass
class GetUserMembershipInConnector200ApplicationJSON:
...
class GetUserMembershipInConnectorResponse:
    ...
    get_user_membership_in_connector_200_application_json_object: Optional[GetUserMembershipInConnector200ApplicationJSON] = dataclasses.field(default=None)
